"""card_rtc -- standalone RTC soft-card PCB with chainable ISA headers.

Combines the rtc soft-card schematic with two 60-pin (2x30) ISA headers (J_IN / J_OUT,
...
NAME = "card_rtc"
TITLE = "RTC soft-card PCB (chainable ISA)"
...
def build(sch, lib):
    ...
    sch.text("Standalone RTC PCB: ISA bus chains J_IN -> J_OUT; card logic taps "
