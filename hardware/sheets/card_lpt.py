"""card_lpt -- standalone Parallel (LPT) soft-card PCB with chainable ISA headers.

Combines the parallel soft-card schematic with two 60-pin (2x30) ISA headers (J_IN / J_OUT,
...
"""
import isa_conn
import parallel as card

NAME = "card_lpt"
TITLE = "Parallel (LPT) soft-card PCB (chainable ISA)"
...
def build(sch, lib):
    ...
    sch.text("Standalone Parallel (LPT) PCB: ISA bus chains J_IN -> J_OUT; card logic taps "
